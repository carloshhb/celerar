...
<div class="login-container">
    ...
    <?php echo form_open('login');?>
        <input type="text" name="username" placeholder="Usuário ou e-mail" value="<?php echo set_value('username'); ?>">
        <?php echo form_error('username', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
        <input type="password" name="password" placeholder="Senha" value="<?php echo set_value('password'); ?>">
    ...
    <div class="login-help">
        <a href="<?php echo site_url('registro');?>">Registrar</a> - <a href="<?php echo site_url('forgotpassword')?>">Esqueceu a senha?</a>
    </div>
</div>
</body>
</html>
